...
Battery::Battery(uint8_t instance) : ELObject(instance, Battery::class_u16), battery{} {
	...
	battery[0xcf] = new uint8_t[0x02]{0x01, Mode::Auto}; // Set/Get 動作状態, 自動
	
	battery[0xda] = new uint8_t[0x02]{0x01, Mode::Auto}; // Set/Get 運転モード設定、 自動
	...
	battery[0xe6] = new uint8_t[0x02]{0x01, Type::Unknown}; // 電池の種類
};
